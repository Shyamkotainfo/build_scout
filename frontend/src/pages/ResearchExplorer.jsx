...
import CandidateDetailPanel from '../components/research/CandidateDetailPanel';
import SearchTracePanel from '../components/research/SearchTracePanel';
...
const ResearchExplorer = () => {
  ...
  // Handle component selection change (reset candidate)
  ...
  if (isLoading && !analysis) {
    return (
      <div className="flex flex-col items-center justify-center h-[calc(100vh-64px)] text-[var(--bs-text-secondary)]">
        ...
        <p className="text-sm font-bold uppercase tracking-widest">Loading research data...</p>
      </div>
    );
  }
        ...
        <div className="bg-[var(--bs-bg-secondary)] border border-[var(--bs-border-medium)] p-8 rounded-lg text-center">
          ...
          <p className="text-sm text-[var(--bs-text-secondary)] mb-6">
            {isInitialLoad
              ...
              : "Please select an analysis from the Dashboard or History to view Research details."}
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="max-w-[1600px] mx-auto w-full px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex flex-col lg:flex-row gap-6 mb-8">
        ...
        {/* Middle Column: Candidate List for selected component */}
